...
public class TableBean implements Serializable {
    ...
    public void init() {
        ...
        userRequests = DatabaseManager.load();
    ...
    public void check() {
        ...
        if(isValid(coordinateX, coordinateY, radius)) {
            ...
            UserRequest userRequest = new UserRequest((float) (timeAfter - timeBefore), new Date(), Float.parseFloat(coordinateX), Float.parseFloat(coordinateY), Float.parseFloat(radius), belong);
            ...
            DatabaseManager.addRequest(userRequest);
        }
    }

    public void clear() {
        userRequests.clear();
        DatabaseManager.clearRequests();
    ...
    public void redrawGraph() {
        ...
        for(UserRequest req: userRequests) {
            ...
            PrimeFaces.current().executeScript("drawPoint(" + pointX + ", " + pointY + ", " + req.isBelong() + ");");
        }
    }
    ...
    public void addFromCanvas() {
        ...
        try {
            ...
            if(isValid(String.valueOf(cordX), String.valueOf(cordY), radius)) {
                ...
                long timeAfter = System.currentTimeMillis();
                UserRequest userRequest = new UserRequest((timeAfter - timeBefore), new Date(), cordX, cordY, Float.parseFloat(radius), belong);
                addRequest(userRequest);
                DatabaseManager.addRequest(userRequest);
